...
Collaboratively define the problem and context. Capture alignment as a concise Epic Brief.

**Next steps**: `@core-flows`, `@tech-plan`
...
5. Now draft the Epic Brief in this response. Structure it as follows:
...
**Save the Epic Brief to `.kiro/specs/epic-brief.md`**
